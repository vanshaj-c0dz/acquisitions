...
export const hashPassword = async password => {
  try {
    ...
    // Attach 'e' to the 'cause' property
...
export const createUser = async ({ name, email, password, role = 'user' }) => {
  try {
    ...
    // Re-throwing 'e' directly is fine and usually doesn't trigger the lint error
    // because you aren't masking the original error with a new one.
    throw e;
  }
};
